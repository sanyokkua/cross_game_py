...
class TicTacToeUiFieldFrame(BaseAppWidget, ttk.Frame):
    ...
    def __init__(self, app_lang: str, root_frame: ttk.Frame, on_field_click_command: Callable) -> None:
        ...
        self.img_cross: tk.PhotoImage = tk.PhotoImage(file=f"{self.base_dir}/resources/img/img_cross.png")
        self.img_zero: tk.PhotoImage = tk.PhotoImage(file=f"{self.base_dir}/resources/img/img_zero.png")
